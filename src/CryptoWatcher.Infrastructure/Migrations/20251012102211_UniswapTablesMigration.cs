...
{
    /// <inheritdoc />
    public partial class UniswapTablesMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UniswapLiquidityPositionCashFlows", x => new { x.PositionId, x.NetworkName, x.TransactionHash });
                    table.ForeignKey(

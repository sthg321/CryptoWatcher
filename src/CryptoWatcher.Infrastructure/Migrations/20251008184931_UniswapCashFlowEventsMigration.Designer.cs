...
namespace CryptoWatcher.Infrastructure.Migrations
{
    ...
    [Migration("20251008184931_UniswapCashFlowEventsMigration")]
    partial class UniswapCashFlowEventsMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoWatcher.Modules.Uniswap.Entities.PoolPositionCashFlow", b =>
                {
                    ...
                    b.OwnsOne("CryptoWatcher.ValueObjects.TokenInfoWithFee", "Token0", b1 =>
                        {
                            b1.Property<decimal>("PoolPositionCashFlowPositionId")
                                .HasColumnType("numeric(20,0)");

                            b1.Property<DateTime>("PoolPositionCashFlowDate")
                                .HasColumnType("timestamp with time zone");

                            b1.Property<int>("PoolPositionCashFlowEvent")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("PoolPositionCashFlowPositionId", "PoolPositionCashFlowDate", "PoolPositionCashFlowEvent");

                            b1.ToTable("PoolPositionCashFlow");

                            b1.WithOwner()
                                .HasForeignKey("PoolPositionCashFlowPositionId", "PoolPositionCashFlowDate", "PoolPositionCashFlowEvent");
                        });
